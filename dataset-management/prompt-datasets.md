...
**Endpoint:** `DELETE /api/v2/projects/{project_id}/prompt-datasets/{dataset_id}/test-cases/bulk`
...
**Endpoint:** `DELETE /api/v2/projects/{project_id}/prompt-datasets/{dataset_id}`
